...
void HariMain(void)
{
	...
	*((int *) 0x0fe4) = (int) shtctl;
	...
	putfonts8_asc_sht(sht_back, 7, binfo->scrny - 22, 0, 8, "Start", 5);
	...
	putfonts8_asc_sht(sht_back, 100, 100, 0, COL8_008484, "Hello master! Hello world!", 12);
	putfonts8_asc_sht(sht_back, 100, 120, 0, COL8_008484, "I am a new operation system withou name.", 40);
	putfonts8_asc_sht(sht_back, 100, 140, 0, COL8_008484, "Glad to be at your service.  *\\(^_^)/*", 38);
