...
{
	boxfill8(sht->buf, sht->xsize, bcolor, lx, ly, lx + length * 8 - 1, ly + 16 - 1); /* 座標消す */
	putfonts8_asc(sht->buf, sht->xsize, lx, ly, color, str); /* 座標書く */
	sheet_refresh(sht, lx, ly, lx + length * 8, ly + 16);
}
